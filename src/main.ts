...
program
  ...
  .description(`Fetch information about a given GitHub user 
    and stores it into de Database`)
...
program
  ...
  .description(`List users stored in the database, 
    with possibility to filter by location 
